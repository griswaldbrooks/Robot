function U = controller3(theta_ref,dth_ref,ddth_ref,theta_ss,dtheta_ss,acc_error)
...
U = J*ddth_ref + F + G + (Kp*(theta_ss - theta_ref) + Ki*acc_error + Kd*(dtheta_ss-dth_ref) + ddth_ref);
