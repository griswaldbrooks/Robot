...
A1 = [  cos(theta(1)),  0,  sin(theta(1)),  a1*cos(theta(1));
        sin(theta(1)),  0,  -cos(theta(1)), a1*sin(theta(1));
        0,              1,  0,              0;
        0               0,  0,              1];
...
A3 = [  cos(theta(3)),  -sin(theta(3)),  0,     a3*cos(theta(3));
        sin(theta(3)),  cos(theta(3)),  0,      a3*sin(theta(3));
        0,              0,              1,      0;
        0               0,  0,              1];
