...
extern IOPin PROGMEM _B4;
extern IOPin PROGMEM _B5;
extern IOPin PROGMEM _B6;
extern IOPin PROGMEM _B7;
extern IOPin PROGMEM _C0;
extern IOPin PROGMEM _C1;
extern IOPin PROGMEM _C2;
extern IOPin PROGMEM _C3;
extern IOPin PROGMEM _C4;
extern IOPin PROGMEM _C5;
extern IOPin PROGMEM _D2;
extern IOPin PROGMEM _D3;
extern IOPin PROGMEM _D5;
extern IOPin PROGMEM _D6;
extern IOPin PROGMEM _D7;
...
extern IOPin PROGMEM _J0;
extern IOPin PROGMEM _J1;
extern IOPin PROGMEM _L0;
extern IOPin PROGMEM _L1;
extern IOPin PROGMEM _L3;
extern IOPin PROGMEM _L4;
extern IOPin PROGMEM _L5;
#define B4 &_B4
#define B5 &_B5
#define B6 &_B6
#define B7 &_B7
...
static IOPort PROGMEM _PORTJ={_SFR_MEM_ADDR(PORTJ),_SFR_MEM_ADDR(DDRJ),_SFR_MEM_ADDR(PINJ)};
...
IOPin PROGMEM _J0 = { &_PORTJ, BV(0)};
IOPin PROGMEM _J1 = { &_PORTJ, BV(1)};
IOPin PROGMEM _L0 = { &_PORTL, BV(0)};
IOPin PROGMEM _L1 = { &_PORTL, BV(1)};
IOPin PROGMEM _L3 = { &_PORTL, BV(3)};
IOPin PROGMEM _L4 = { &_PORTL, BV(4)};
IOPin PROGMEM _L5 = { &_PORTL, BV(5)};
#endif

#ifndef BUILDING_LIBRARY
const uint8_t NUM_PCINT_PINS = 11;
const IOPin* PROGMEM PCINT_PINS[]={null,null,null,null,B4,B5,B6,B7,E0,J0,J1};
#endif
...
// ------------------- lbComm -------------------
extern MAKE_WRITER(lbCommSendByte);
extern MAKE_READER( lbCommGetByte);

// Create hardware UART lbComm
extern HW_UART _lbComm;
#define lbComm &_lbComm
#define UART3 lbComm

// ------------------- uart0 -------------------
extern MAKE_WRITER(uart0SendByte);
extern MAKE_READER( uart0GetByte);

// Create hardware UART uart0
extern HW_UART _uart0;
#define uart0 &_uart0
#define UART0 uart0
...
const PROGMEM Timer PROGMEM pgm_Timers[] = {
	...
	MAKE_TIMER(__timer4_data,TCNT4,TCCR4B,true,false,TIMER_ALL_MODES,
		...
		__timer4Compare,TIMSK4,TOIE4,TIFR4,TOV4,ICR4,TIMSK4,ICIE4,TIFR4,ICF4,TCCR4B,ICES4,L0),
...
extern Sharp_GP2Y0A21YK ir_0;
extern Sharp_GP2D12 ir_1;
extern Sharp_GP2D12 ir_2;
extern Sharp_GP2Y0A21YK ir_3;
extern Sharp_GP2Y0A21YK ir_4;
